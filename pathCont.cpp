...
{
    return(_simplePathPoints.size());
}
int CPathCont::getBezierPathPointCount()
{
    return(_bezierPathPoints.size());
}
// 添加 贝赛尔点
//
